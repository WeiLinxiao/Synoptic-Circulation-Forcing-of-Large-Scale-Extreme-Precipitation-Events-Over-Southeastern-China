...
for j in [0,1,2,3,4,5]:
    ...
    '''
fig.savefig('/media/dai/DATA1/research/6.Southeastern_China_Clustering/code2/Figures/Figure.Sx.climatological_Z500_IVT_type_in_LSExP_days_'+str(qu)+'_'+str(ar)+'.png',dpi=1500, bbox_inches='tight')
